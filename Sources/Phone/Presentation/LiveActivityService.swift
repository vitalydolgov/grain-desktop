...
enum LiveActivityService {
    ...
    static func update(from state: RuntimeState) async {
    ...
    private static func contentState(for state: RuntimeState) -> TimerActivityAttributes.ContentState {
    ...
    private static func requestActivity(_ state: TimerActivityAttributes.ContentState) {
