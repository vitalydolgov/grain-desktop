...
If the user confirms, proceed with the squash: run !`git reset --soft $(git merge-base HEAD main)` to fold all branch commits into the index, then commit with the confirmed message.
